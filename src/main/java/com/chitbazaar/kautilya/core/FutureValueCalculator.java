...
public class FutureValueCalculator {
    ...
    public Double netFutureValue(List<Double> cashFlows, Double ratePerInterval, Double compoundingFrequency) {
        Double nfv = 0.0;
    ...
    public Double netFutureValue(List<Double> cashFlows, Double ratePerInterval) {
