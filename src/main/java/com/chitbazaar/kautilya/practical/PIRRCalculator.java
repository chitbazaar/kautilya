...
public class PIRRCalculator {
    ...
    public Double pirr(List<Double> cashFlows) {
        return pirr(cashFlows, precision);
    }

    public Double pirrAnnualized(List<Double> cashFlows) {
        return pirrAnnualized(cashFlows, CashFlowInterval.Monthly, precision);
    }

    public Double pirrAnnualized(List<Double> cashFlows, Integer precision) {
        return pirrAnnualized(cashFlows, CashFlowInterval.Monthly, precision);
    }

    public Double pirrAnnualized(List<Double> cashFlows, CashFlowInterval interval, Integer precision) {
        CashFlowInfo cashFlowInfo = new CashFlowInfo(cashFlows, precision);
